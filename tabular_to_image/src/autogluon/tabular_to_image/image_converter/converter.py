...
class Image_converter(object):
    ...
    def image_len(self):
        train,val,test=self._store.load_data(self,self.saved_path)
        return len(train['X_train_img']),len(val['X_val_img']),len(test['X_test_img'])
    
    def num_class(self):
        _,_,test=self._store.load_data(self.store_type,self.saved_path)
    ...
    def image_tensor(self): 
        ...
        train,val,test=self._store_type.load_data(self.store_type,self.saved_path)
