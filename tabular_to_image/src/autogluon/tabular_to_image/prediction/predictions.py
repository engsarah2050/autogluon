...
class ImagePredictions:#(AbstractNeuralNetworkModel):
    ...
    def init_train(self,model_type, epochs,patience,scheduler=None):
        ...
        commonModels=[#'resnet18','resnet34','resnet50','resnet101','resnet152', 
                    ...
                    #  'googlenet','shufflenet_v2_x0_5','shufflenet_v2_x1_0','shufflenet_v2_x1_5','shufflenet_v2_x2_0','mobilenet_v2','mobilenet_v3_small','mobilenet_v3_large','wide_resnet50_2', 'wide_resnet101_2','mnasnet0_5','mnasnet0_75','mnasnet1_0','mnasnet1_3'
